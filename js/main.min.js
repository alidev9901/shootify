...
const photoVideo = document.querySelectorAll('.action-video');
...
if( photoVideo ) {
  ...
  photoVideo.forEach(function(elem) {

    const video = elem.querySelector('video');

    elem.addEventListener('mouseover', function() {
      video.play();
      elem.classList.add('action-video--playing')
    });
    ...
    elem.addEventListener('mouseout', function() {
      video.pause();
      elem.classList.remove('action-video--playing')
    });
